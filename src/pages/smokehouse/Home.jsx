...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      const events = await getUpcomingEvents(Site.Smokehouse, 4);
      setEvents(events);
      setLoading(false);
    };
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="font-medium">
                    ...
                    brought his famed BBQ to Rockland and has added a twist.
                    Here you can find some of the best BBQ East of the
                    Mississippi. Our smoking process starts with our own BBQ
                    spice marinated overnight. Then they are slow smoked for up
                    to 12 hours using local hard woods until tender, moist, and
                    full of flavor
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-normal text-sm">
                    ...
                    Ring” which develops along the outside of the meat and
                    around the bones in our products. You can be assured that
                    despite this red ring all of our meats are smoked to well
                    done and that the “Smoke Ring” you see is a sign of
                    outstanding authentic BBQ!!!
                  </p>
                </div>
